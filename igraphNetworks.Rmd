...
Each element of a graph (vertices and edges) can be customized by passing in the appropriate attributes property. 
...
Oftentimes, you will need to generate a bunch of graphs from scratch, for a background distribution or something.
...
##Take Home Points
  ...
  * Exploring your data is essential to developing hypotheses
  * Leverage current code
  * Different Representations of Data can help you achieve different tasks
